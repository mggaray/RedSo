...
<div class="login-page">
  <div class="form">
    ...
    <label for="nombre" style="color:black">Nombre</label>
      ...
      <small class="text-danger"><?php echo(isset($errores["pass"]))?$errores["pass"]:"" ?></small><br>

      <label for="conpass" style="color:black">Confirmar contraseña</label>
      <input type="password" placeholder="Ingrese su contraseña"id="conpass" name="conpass" required/>
      <small class="text-danger"><?php echo(isset($errores["conpass"]))?$errores["conpass"]:"" ?></small><br>

      <button type="submit">Entrar</button><br>

      <p class="message">¿Ya está registrado? <a href="login.php">Ingrese a su cuenta</a></p> <br>
    </form>
  </div>
</div>
